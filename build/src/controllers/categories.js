...
var CategoriesController = function () {
    ...
    _createClass(CategoriesController, null, [{
        ...
        value: function () {
            ...
            function getAllCategories(_x, _x2) {
        ...
        value: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req, res) {
                var query, name, logoLink, values, _ref4, rows, rowCount;

                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                query = 'insert into categories (name, logo_link) values ($1 , $2)';
                                name = req.body.name;
                                logoLink = req.body.logoLink;
                                values = [name, logoLink];
                                _context2.prev = 4;
                                _context2.next = 7;
